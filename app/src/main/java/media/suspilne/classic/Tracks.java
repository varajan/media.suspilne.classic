...
class Tracks {
    ...
    private List<TrackEntry> items = new ArrayList<>(Arrays.asList(
            ...
            new TrackEntry(6, R.string.track_006, R.string.rachmaninov),
            ...
            new TrackEntry(22, R.string.track_022, R.string.chaikovsky),
            ...
            new TrackEntry(32, R.string.track_032, R.string.bellini),
            new TrackEntry(33, R.string.track_033, R.string.bellini),
            new TrackEntry(34, R.string.track_034, R.string.bellini),
            new TrackEntry(35, R.string.track_035, R.string.bellini),
            new TrackEntry(36, R.string.track_036, R.string.lysenko),
            ...
            new TrackEntry(48, R.string.track_048, R.string.shostakovich),
            new TrackEntry(49, R.string.track_049, R.string.shostakovich),
            new TrackEntry(50, R.string.track_050, R.string.shostakovich),
            new TrackEntry(51, R.string.track_051, R.string.shostakovich),
